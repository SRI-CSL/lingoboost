...
public class SleepService extends Service implements SensorEventListener, OnInitListener {
    ...
    public static final double MOVEMENT_THRESH = 12.0; // how much movement is needed to trigger a backoff
    public static final String SLEEP_FINISHED_INTENT = "com.sri.csl.langlearn.SLEEP_FINISHED";

    private class SleepServiceBinder extends Binder {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (mySensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            if ((curTime - lastUpdate) > 100) {
                ...
                double speed = Math.sqrt((x - oldx) * (x - oldx) + (y - oldy) * (y - oldy) + (z - oldz) * (z - oldz)) / diffTime * 10000;
    ...
    // private void logTimestamp(String message) { //write something to the log file with a timestamp.
